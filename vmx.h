...
enum pin_based_vm_exec_ctrl {
	PIN_BASED_EXEC_EXTERNAL_INTERRUPT = 1 << 0,
	PIN_BASED_EXEC_NMI = 1 << 3,
	PIN_BASED_EXEC_VIRTUA_NMI = 1 << 5,
	PIN_BASED_EXEC_PREEMPTION_TIMER = 1 << 6,
	PIN_BASED_EXEC_POSTED_INT = 1 << 7,
};

enum cpu_based_vm_exec_ctrl {
	CPU_BASED_EXEC_INTERRUPT_WINDOW = 1 << 2,
	CPU_BASED_EXEC_USC_TSC_OFFSET = 1 << 3,
	//CPU_BASED_EXEC_HLT_EXIT = 1 << 7,
	CPU_BASED_EXEC_HLT_EXIT = 0x00000080,
	CPU_BASED_EXEC_INVLPG_EXIT = 1 << 9,
	CPU_BASED_EXEC_NWAIT_EXIT = 1 << 10,
	CPU_BASED_EXEC_RDPMC_EXIT = 1 << 11,
	CPU_BASED_EXEC_RDTSC_EXIT = 1 << 12,
	CPU_BASED_EXEC_CR3_LOAD_EXIT = 1 << 15,
	CPU_BASED_EXEC_CR3_STORE_EXIT = 1 << 16,
	CPU_BASED_EXEC_CR8_LOAD_EXIT = 1 << 19,
	CPU_BASED_EXEC_CR8_STORE_EXIT = 1 << 20,
	CPU_BASED_EXEC_USE_TPR_SHADOW = 1 << 21,
	CPU_BASED_EXEC_NMI_WINDOW_EXIT = 1 << 22,
	CPU_BASED_EXEC_MOV_DR_EXIT = 1 << 23,
	CPU_BASED_EXEC_UNCONDITIONAL_IO_EXIT = 1 << 24,
	CPU_BASED_EXEC_USE_IO_BITMAPS = 1 << 25,
	CPU_BASED_EXEC_MONITOR_TRAP_FLAG = 1 << 28,
	CPU_BASED_EXEC_USE_MSR_BITMAPS = 1 << 29,
	CPU_BASED_EXEC_PAUSE_EXIT = 1 << 30,
	CPU_BASED_EXEC_ACTIVE_SECONDARY_CTRLS = 1 << 31,
};

enum second_processor_based_vm_exec_ctrl {
	SEOCND_EXEC_VIRTUAL_APIC = 1 << 0,
	SECOND_EXEC_ENABLE_EPT = 1 << 1,
	SECOND_EXEC_DESCRPTOR_TABLE = 1 << 2,
	SECOND_EXEC_ENABLE_RDTSCP = 1 << 3,
	SECOND_EXEC_VIRTUAL_x2APIC = 1 << 4,
	SECOND_EXEC_ENABLE_VPID = 1 << 5,
	SECOND_EXEC_WBINVD_EXIT = 1 << 6,
	SECOND_EXEC_UNRISTRICTED_GUEST = 1 << 7,
	SECOND_EXEC_APIC_REG_VIRTUAL = 1 << 8,
	SECOND_EXEC_VIRTUA_INTERRUPT_DELIVERY = 1 << 9,
	SECOND_EXEC_PAUSE_LOOP_EXIT = 1 << 10,
	SECOND_EXEC_RDRAND_EXIT = 1 << 11,
	SECOND_EXEC_INVPCID = 1 << 12,
	SECOND_EXEC_VM_FUNCTIONS = 1 << 13,
	SECOND_EXEC_VMCS_SHADOWING = 1 << 14,
	SECOND_EXEC_ENCLS_EXIT = 1 << 15,
	SECOND_EXEC_RDSEED_EXIT = 1 < 16,
	SECOND_EXEC_PML = 1 << 17,
	SECOND_EXEC_EPT_VIOLTION = 1 << 18,
	SECOND_EXEC_CONCEAL_VMX_FROM_PT = 1 << 19,
	SECOND_EXEC_XSAVES_XSTORES = 1 << 20,
	SECOND_EXEC_MODE_BASED_EXEC_CTRL = 1 << 22,
	SECOND_EXEC_SUB_PASE_WRITE_PERMISSION = 1 << 23,
	SECOND_EXEC_USE_TSC_SCALING = 1 << 25,
	SECOND_EXEC_ENCLV_EXITING = 1 << 28,
};
